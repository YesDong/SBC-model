% This codes generates Figure 13 and Figure 14, which illustrate the examples of
% opinion evolution and the relations between equilibrium state and the
% parameters in hybrid LMF-SBC I.
clear all
close all
clc
load('D:\code\data\equilibrium\hybrid\hsd_Xt_all.mat')
load('D:\code\data\equilibrium\hybrid\X_R_all.mat')
load('D:\code\data\equilibrium\hybrid\X_p_all.mat')
figure(1);
T=50;
...
legend([L1 L2 L3],['States in hybrid LMF-SBC \uppercase\expandafter{\romannumeral1} 1'],['${W_1}_{[1]}$'],['${W_2}_{[' num2str(w) ']}$'],'FontSize',14,'Interpreter','latex')
set(axes1,'FontSize',12);
% saveas(gcf,['F:\code4\tu\equili_hybrid1_ex' num2str(w) '.eps'],'epsc')
end
...
legend(P2,'hybrid LMF-SBC \uppercase\expandafter{\romannumeral1} 1','hybrid LMF-SBC \uppercase\expandafter{\romannumeral1} 2','hybrid LMF-SBC \uppercase\expandafter{\romannumeral1} 3','hybrid LMF-SBC \uppercase\expandafter{\romannumeral1} 4','FontSize',14,'Interpreter','latex')
% axis([0.1,1,0.36,0.52])
grid on
set(axes1,'FontSize',12);
%saveas(gcf,'F:\code4\tu\equili_hybrid1_pa1.eps','eps')
...
legend(P,'hybrid LMF-SBC \uppercase\expandafter{\romannumeral1} 1','hybrid LMF-SBC \uppercase\expandafter{\romannumeral1} 2','hybrid LMF-SBC \uppercase\expandafter{\romannumeral1} 3','hybrid LMF-SBC \uppercase\expandafter{\romannumeral1} 4','FontSize',14,'Interpreter','latex')
% legend([P P2 P3],'hybrid LMF-SDOD \uppercase\expandafter{\romannumeral1} 1','hybrid LMF-SDOD \uppercase\expandafter{\romannumeral1} 2','hybrid LMF-SDOD \uppercase\expandafter{\romannumeral1} 3','hybrid LMF-SDOD \uppercase\expandafter{\romannumeral1} 4',['${W_1}_{[1]}$'],['${W_2}_{[\omega_2]}$'],'FontSize',10,'Interpreter','latex')
grid on
set(axes2,'FontSize',12);
%saveas(gcf,'F:\code4\tu\equili_hybrid1_pa2.eps','eps')
...
legend(P2,'hybrid LMF-SBC \uppercase\expandafter{\romannumeral1} 1','hybrid LMF-SBC \uppercase\expandafter{\romannumeral1} 2','hybrid LMF-SBC \uppercase\expandafter{\romannumeral1} 3','hybrid LMF-SBC \uppercase\expandafter{\romannumeral1} 4','FontSize',14,'Interpreter','latex')
 axis([0,0.12,0.48427,0.5])
grid on
set(axes3,'FontSize',12);

%saveas(gcf,'F:\code4\tu\equili_hybrid1_pa3.eps','eps')
