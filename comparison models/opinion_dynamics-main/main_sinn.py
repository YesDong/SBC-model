...
p.add_argument('--method', type=str, default="AsLM", 
               help='Options are "Voter", "DeGroot", "AsLM", "SLANT", "SLANT+", "NN", "SINN"')

p.add_argument('--dataset', type=str, default="Re_Pol", 
               help='Options are "sample_twitter_Abortion","TD","TS","Re_Pol","We_hea"')
...
p.add_argument('--type_odm', type=str, default="BCM",
...
def main_sinn(data_type, method, root_path):
    ...
    ##########################################
    df = pd.read_csv("working/posts_final_"+data_type+".csv", delimiter=",") 
